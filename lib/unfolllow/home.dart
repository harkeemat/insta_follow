...
class MyCustomunfollow extends StatefulWidget {
...
class MyCustomFormState extends State<MyCustomunfollow> {
            ...
            Center(
                            ...
                            children: <Widget>[
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                    ...
                                    enabled: searchbtn== "false" ? true :false,
                                    onChanged: (String value) async {
                                      setState(() {
                                        value != '' ? shofiledfollow="true" :shofiledfollow="false";
              //print(shofiledfollow);
                              ...
                              TextFormField(
                                ...
                                enabled: shofiledfollow== "false" ? true :false,
                                onChanged: (String value) async {
                                      setState(() {
                                        value != '' ? searchbtn="true" :searchbtn="false";
              //print(shofiledfollow);
                                      });
                          ...
                          child: RaisedButton(
                            onPressed: () {
                              setState(() {
                                ...
                                if (product != null) {
                                  var titles = "Insta Unfollowing";
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => Listdata(
                                          products: product, title: titles,user:username.text, pass: userPassword.text, instauser : instafolllow.text, status : "follow",tag :searchtag.text),
                                    ),
                                  );
                                } else {
